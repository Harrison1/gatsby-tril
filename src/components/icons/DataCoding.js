...
const DataCoding = ({ height, width }) =>
  <svg version="1.1" id="datacoding" xmlns="http://www.w3.org/2000/svg" width={ width } height={ height } x="0px" y="0px" aria-labelledby="datacodingTitle" viewBox="0 0 337.4 280">
    <title id="datacodingTitle">Data Coding Icon</title>
    <g>
      <g>
        <path className="blue-icon" d="M249.7,47.7c-24.5-24.5-57.1-38-91.7-38c-34.6,0-67.2,13.5-91.7,38c-50.6,50.6-50.6,132.8,0,183.4
    ...
    <path className="blue-icon" d="M159,0C81.7,0,19,62.7,19,140s62.7,140,140,140s140-62.7,140-140S236.3,0,159,0z M159,253.8
